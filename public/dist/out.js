(() => {
  ...
  // src/00-components/Checkbox/CheckboxComponent.tsx
  var import_react = __toModule(require_react());
  var Checkbox = ({label, checked, onChange}) => {
    const [isChecked, setIsChecked] = (0, import_react.useState)(checked);
    const handleChange = (checked2) => {
      setIsChecked(checked2);
      onChange(checked2);
    };
    return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("label", null, /* @__PURE__ */ import_react.default.createElement("input", {
      type: "checkbox",
      checked: isChecked,
      onChange: (e) => handleChange(e.target.checked)
    }), label));
  };
  var CheckboxComponent_default = Checkbox;

  // src/02-pages/Home/HomePage.tsx
  var import_react2 = __toModule(require_react());
  var HomePage = () => {
    return /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("h1", null, "Home Page"));
  };
  ...
  var App = ({name}) => {
    return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("h1", null, name), /* @__PURE__ */ import_react3.default.createElement(HomePage_default, null), /* @__PURE__ */ import_react3.default.createElement(CheckboxComponent_default, {
      label: "Hello",
      checked: true,
      onChange: () => {
      }
  ...
  root.render(/* @__PURE__ */ import_react3.default.createElement(App, {
    name: "trebuchet project launcher"
  }));
})();
